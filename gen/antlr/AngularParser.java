...
public class AngularParser extends Parser {
	...
	public static final int
		...
		WS=59, COMMENT=60, MULTILINE_COMMENT=61, INTERFACE=62, PIPE=63, QDOT=64, 
		ELLIPSIS=65;
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 4611686018427392016L) != 0) );
			setState(138);
			match(EOF);
			}
		}
	...
	public final ObjectLiteralContext objectLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==IDENTIFIER || _la==ELLIPSIS) {
				{
				setState(562);
				objectElement();
				setState(567);
