...
interfaceDeclaration
    : EXPORT? INTERFACE IDENTIFIER LBRACE interfaceMembers? RBRACE
    ;

interfaceMembers
    : interfaceMember (SEMI interfaceMember)* SEMI?
    ;
...
typeAnnotation
    : typeExpr (LBRACKET RBRACKET)?                             #typeAnnotated
    ;

typeExpr
    : typeTerm (PIPE typeTerm)*
    ;
...
postfixPart
    ...
    | optionalPropertyAccess                                    #optPropertyAcc
...
objectLiteral
    : LBRACE (objectElement (COMMA objectElement)*)? RBRACE     #objLiteral
    ;
