...
public class FieldDeclaration implements ClassMember {
    ...
    public TypeAnnotation getType() { return _type; }
    public Expression getInitializer() { return _initializer; }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("FieldMember( Identifier = ").append(_name);
        if (_type != null) sb.append(", Type = ").append(_type.toString());
        if (_initializer != null) sb.append(", Value = ").append(_initializer.toString());
        sb.append(" )");
        return sb.toString();
    }
}
